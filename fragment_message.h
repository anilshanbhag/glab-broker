...
public:
	...
	// --------------------------------------------------------------------
		...
		return read<OsModel, block_data_t, size_t> (buffer + TOTAL_SIZE_POS);
	}
	// --------------------------------------------------------------------
	inline void set_total_size(size_t number) {
		write<OsModel, block_data_t, size_t> (buffer + TOTAL_SIZE_POS, number);
	}
	// --------------------------------------------------------------------
        inline size_t index() {
		return read<OsModel, block_data_t, size_t> (buffer + INDEX_POSITION_POS);
	}
	// --------------------------------------------------------------------
	inline void set_index(size_t number) {
		write<OsModel, block_data_t, size_t> (buffer + INDEX_POSITION_POS, number);
	}
	// --------------------------------------------------------------------
